...
namespace Microsoft.WindowsAzure.MobileServices
{
    ...
    internal static partial class TypeExtensions
    {
        ...
        /// <summary>
        /// Get the properties for a given type.s
        /// </summary>
        ...
        public static IEnumerable<PropertyInfo> GetProperties(this Type type, bool inherit, bool publicOnly)
        {
            ...
            IEnumerable<PropertyInfo> properties =
                (inherit ?
                    type.GetBaseTypesAndSelf().SelectMany(GetDeclaredProperties) :
		...
		public static IEnumerable<PropertyInfo> GetDeclaredProperties (this Type self)
		{
			return
				self.GetProperties (BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static |
									BindingFlags.Instance);
		}

		public static IEnumerable<FieldInfo> GetDeclaredFields (this Type self)
		{
			return
				self.GetFields (BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static |
								BindingFlags.Instance);
		}

		public static IEnumerable<MethodInfo> GetDeclaredMethods (this Type self)
		{
			return
				self.GetMethods (BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Static |
				                 BindingFlags.Instance);
		}

		public static T GetCustomAttribute<T> (this MemberInfo self, bool inherit) where T : Attribute
		{
			return self.GetCustomAttributes (typeof (T), inherit).Cast<T>().FirstOrDefault();
		}
        ...
        public static IEnumerable<FieldInfo> GetFields(this Type type, bool inherit, bool publicOnly)
        {
            ...
            IEnumerable<FieldInfo> fields = inherit ?
                type.GetBaseTypesAndSelf().SelectMany(GetDeclaredFields) :
        ...
        private static Type GetIEnumerableClosedType(Type type)
        {
            ...
            {
                return GetIEnumerableClosedType(type.BaseType);
            }
        ...
        private static IEnumerable<MethodInfo> GetMethods(Type type, string name, Type[] parameterTypes)
        {
            return GetBaseTypesAndSelf(type)
                .SelectMany(t => t.GetDeclaredMethods().Where(m => m.Name == name))
                .Where(m => 
                {
        ...
        public static MemberInfo FindInstanceProperty(Type type, string name)
        {
            return
                ...
                .SelectMany(t => t.GetDeclaredProperties().Where(
